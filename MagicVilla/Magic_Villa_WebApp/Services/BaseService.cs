...
namespace Magic_Villa_WebApp.Services
{
    public class BaseService : IBaseService
    {
        ...
        public IHttpClientFactory httpClient {  get; set; }  // used for calling the API IN WEB project


        public BaseService(IHttpClientFactory httpClient) // dependency Injection 
        {
